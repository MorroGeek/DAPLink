...
__STATIC_INLINE void DAP_SETUP(void)
{
    ...
    GPIO_InitStruct.Pin = SWCLK_TCK_PIN | SWDIO_OUT_PIN | SWDIO_IN_PIN;
    ...
    HAL_GPIO_WritePin(GPIOA, SWCLK_TCK_PIN, 1);
    HAL_GPIO_WritePin(GPIOA, SWDIO_OUT_PIN, 1);
    HAL_GPIO_WritePin(GPIOA, TDI_PIN, 1);
    HAL_GPIO_WritePin(GPIOA, nRESET_PIN, 1);
#endif
